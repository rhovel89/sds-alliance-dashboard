-- Canonical identity for the current auth user (prefers player_auth_links, fallback to oldest players row)
...
-- View: "my alliances" without needing player_id in the UI (fixes stale/duplicate membership lookups)
