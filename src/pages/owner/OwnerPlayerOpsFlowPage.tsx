...
import OwnerAccessControlHubPage from "./OwnerAccessControlHubPage";
import OwnerRolesPermissionsV2Page from "./OwnerRolesPermissionsV2Page";

type StepDef = {
  id: "intake" | "memberships" | "onboarding" | "permissions" | "roles";
  title: string;
  render: () => JSX.Element;
};
...
const STEPS: StepDef[] = [
  ...
  { id: "memberships", title: "Memberships", render: () => <OwnerMembershipsPage /> },
  { id: "onboarding", title: "Onboarding", render: () => <OwnerOnboardingQueuePage /> },
  { id: "permissions", title: "Permissions", render: () => <OwnerAccessControlHubPage /> },
    ...
    <RequireAdmin>
      <div style={{ display: "flex", minHeight: "calc(100vh - 60px)" }}>
        <aside style={{ width: 260, padding: 16, borderRight: "1px solid rgba(255,255,255,0.08)" }}>
          <div style={{ fontWeight: 800, marginBottom: 8 }}>Player Ops</div>
